...
<body>
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<!--Pembuatan form menggunakan Method POST dan memanggil file action-->
			<form method="POST" action="tgssimpan.php" id="peserta">
				<!--Option Jenis Pendaftaran-->
							...
							<p>
								<i>
									* Nomor Peserta Ujian adalah 20 Digit yang Tertera dalam Sertifikat 
									<i style="color: red; font-weight: bold;">NO. SKHUN SD</i>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<button style="float: right;" type="button" name="submit" class="btn btn-primary"><a style="color: white;" href="index.php">Lihat Daftar Calon Siswa</a></button>
					</div>
				</div>
			</form>
		</div>
