...
<?php
//Deklarasi variabel yang mempunyai value null
$error_nama = "";
$error_email = "";
$error_web = "";
$error_pesan = "";
...
//Untuk mengecek apakah field sudah terisi dengan benar sesuai format sistem
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	else
	{
		...
		if (!is_numeric($telp))
		{
			$error_telp = 'Hanya boleh format angka';
		}	
	}
}
...
<!--Membuat form inputan/pengisian-->
<div class="row">
<div class="col-md-6">
<div class="card">
